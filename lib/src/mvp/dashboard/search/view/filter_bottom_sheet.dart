                          ...
                          SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  width:
                                      VariableUtilities.screenSize.width * 0.30,
                                  child: ListView.builder(
                                    physics:
                                        const NeverScrollableScrollPhysics(),
                                    shrinkWrap: true,
                                    itemCount: searchProvider.searchCardData
                                        .left.data!.attributes!.length,
                                                  ...
                                                  onChanged: (text) {
                                                    ...
                                                    if (searchProvider
                                                      ...
                                                      if (text.length >= 2) {
                                                        ...
                                                        searchProvider.searchBrand(
                                                            searchProvider
                                                                .brandSearchTextController
                                                                .text);
                                                      }
                                                    }
                                                            ...
                                                            children: [
                                                              ...
                                                              Checkbox(
                                                                ...
                                                                onChanged:
                                                                  ...
                                                                  searchProvider
                                                                      .onBrandSelectAndDeSelect(
                                                                          searchProvider
                                                                              .searchInstrumentsList[index]);
                                                                },
                                                              ),
                                                                  ...
                                                                  Checkbox(
                                                                    activeColor:
                                                                        VariableUtilities
                                                                            .theme
                                                                            .blackColor,
                                                                    value: searchProvider.selectedValues.contains(searchProvider
                                                                        .searchCardData
                                                                        .left
                                                                        .data!
                                                                        .attributes![
                  ...
                  children: [
                    ...
                    Expanded(
                      child: PrimaryButton(
                          onTap: () async {
                            Navigator.pop(context);
                            await searchProvider.callSearchCardApi(context,
                                pageNumberSearchByFilter: 1);
                          },
                          title: 'Show'),
                    ),
                  ],
