...
import 'package:bb3_ecommerce_app/src/widget/input/input_field.dart';
...
class OTPTextField extends StatefulWidget {
  ...
  const OTPTextField({
    ...
    this.otpFieldStyle,
    this.hasError = false,
    this.cursorColor = const Color(0xFF7c7c7c),
    this.margin,
